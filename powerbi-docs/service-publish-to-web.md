...
> 
> [!IMPORTANT]
> Power BI-Administratoren haben im Verwaltungsportal die Möglichkeit, „Im Web veröffentlichen“ für Benutzer zu deaktivieren. Legen Sie in **Mandanteneinstellungen** die Option **Im Web veröffentlichen** auf **Aus** fest. Dies ist eine für den gesamten Mandanten geltende Einstellung. Weitere Informationen finden Sie unter [Power BI – Verwaltungsportal](service-admin-portal.md).
> 
> 
...
2. Berichte, die lokal gehostete Analysis Services-Tabellendaten verwenden
