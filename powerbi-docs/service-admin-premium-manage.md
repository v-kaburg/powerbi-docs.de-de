...
* **Power BI Embedded:** [Erstellen einer Power BI Embedded-Kapazität im Azure-Portal](https://docs.microsoft.com/azure/power-bi-embedded/create-capacity)
...
Standardmäßig unterstützen Power BI Premium- und Power BI Embedded-Kapazitäten nur die Workload, die mit der Ausführung von Power BI-Abfragen in der Cloud verbunden ist. Nun werden zwei weitere Workloads in der Vorschauversion unterstützt: **Paginierte Berichte** und **Dataflows**. Weitere Informationen finden Sie unter [Workloads in Premium-Kapazität](service-premium.md#workloads-in-premium-capacity).

Führen Sie die folgenden Schritte aus, um Workloads im Power BI-Verwaltungsportal zu aktivieren.
