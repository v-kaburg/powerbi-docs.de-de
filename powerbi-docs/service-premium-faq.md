...
* Sie können auch auf das **Kontaktsymbol** ![](media/service-premium-faq/power-bi-contact-me-icon.png) in der rechten unteren Ecke dieses Browserfenster klicken.
...
„Kapazität“ bezieht sich auf eine benannte Kapazität, die durch einen Administrator über das Kapazitätsverwaltungsportal von Power BI Premium bereitgestellt wird. Eine Kapazität ist eine Gruppierung von einem oder mehreren Knoten. Weitere Informationen finden Sie im [Microsoft Power BI Premium-Whitepaper](https://aka.ms/pbipremiumwhitepaper).
...
Power BI Premium ist als ein Add-On von Power BI Pro im Administrationscenter von Office 365 verfügbar. Weitere Informationen finden Sie unter [How to purchase Power BI Premium (Erwerben von Power BI Premium)](service-admin-premium-purchase.md). Sie können auch Ihren Betreuer von Microsoft kontaktieren, um weitere Informationen einzuholen.

**Woher weiß ich, wie viel Power BI Premium-Kapazität ich kaufen muss?**  
Verwenden Sie diesen [Kostenrechner](https://powerbi.microsoft.com/calculator/), um zu schätzen, wie viel Power BI Premium-Kapazität Sie möglicherweise benötigen.
...
Weitere Informationen zu Power BI-Berichtsserver finden Sie unter [Erste Schritte mit Power BI-Berichtsserver](report-server/get-started.md).
...
Weitere Informationen zu Apps finden Sie unter [Was sind Apps in Power BI?](service-install-use-apps.md).
...
Benutzer des kostenlosen Power BI-Diensts profitieren vom Zugriff auf alle Datenquellen, von erhöhter Arbeitsbereichsspeicherbegrenzung und von höheren Aktualisierungs- und Streamingraten. Diese Änderungen werden am 1. Juni 2017 wirksam. Unter [Self-Service-Registrierung für Power BI](service-self-service-signup-for-power-bi.md) erfahren Sie mehr. Power BI Desktop steht kostenlos zur Verfügung.

Informationen hinsichtlich des Angebots der erweiterten Pro-Testversion finden Sie unter [Aktivierung der erweiterten Pro-Testversion](service-extended-pro-trial.md).
...
Weitere Informationen finden Sie in den [Geschäftsbedingungen](https://aka.ms/power-bi-trial) der erweiterten Pro-Testversion.

Informationen hinsichtlich des Angebots der erweiterten Pro-Testversion finden Sie unter [Aktivierung der erweiterten Pro-Testversion](service-extended-pro-trial.md).

**Was sollten Benutzer tun, wenn sie nicht zur Nutzung der erweiterten Power BI Pro Testversion berechtigt sind?**  
Registrieren Sie sich [hier](https://app.powerbi.com/signupredirect?pbi_source=web) für eine 60-tägige Standardtestversion von Power BI.
...
Ja, Sie sollten darüber nachdenken, Ihre eingebettete Analyselösung zu Power BI Premium zu migrieren. Weitere Informationen dazu finden Sie unter [Migrieren von Inhalten aus Arbeitsbereichssammlungen von Power BI Embedded zu Power BI](developer/migrate-from-powerbi-embedded.md).

**Wie migriere ich meine vorhandene App zu Power BI Embedded?**  
Eine Anleitung zum Migrieren von Apps finden Sie in der [Dokumentation zur Migration](developer/migrate-from-powerbi-embedded.md).
...
Power BI Embedded wird erfolgreich mit Power BI-Dienst konvergiert und wird so erworben, bereitgestellt und verwaltet. Weitere Informationen finden Sie unter [Einbetten mit Power BI](developer/embedding.md).
