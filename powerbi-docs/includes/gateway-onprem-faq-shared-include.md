...
**Frage:** Wie wird der eigentliche Windows-Dienst bezeichnet?  
**Antwort:** Der Name des Gateways unter „Dienste“ lautet „Lokaler Datengatewaydienst“.
...
**Frage:** Gibt es eingehende Verbindungen aus der Cloud zum Gateway?  
...
**Frage:** Welche Latenz besteht für die Ausführung von Abfragen der Datenquelle vom Gateway? Was ist die beste Architektur?  
...
**Frage:** Bestehen spezielle Anforderungen hinsichtlich der Netzwerkbandbreite?  
**Antwort:** Es wird empfohlen, einen guten Durchsatz für die Netzwerkverbindung sicherzustellen. Jede Umgebung ist anders, und dies hängt auch von der Datenmenge ab, die gesendet wird. Mithilfe von ExpressRoute könnten Sie einen gewissen Durchsatz zwischen lokalen und den Azure-Rechenzentren gewährleisten.
...
**Frage:** Kann der Gateway-Windows-Dienst mit einem Azure Active Directory-Konto ausgeführt werden?  
...
**Frage:** Ist die Hochverfügbarkeit von Gateways geplant?  
**Antwort:** Ja, dies ist ein Bereich, der vom Power BI-Team bearbeitet wird. Bitte informieren Sie sich im [Power BI-Blog](https://powerbi.microsoft.com/blog/) über Neuigkeiten zu diesem Feature.

**Frage:** Welche Optionen sind für die Notfallwiederherstellung verfügbar?  
**Antwort:** Sie können ein Gateway mithilfe des Wiederherstellungsschlüssels wiederherstellen oder verschieben. Wenn Sie das Gateway installieren, stellen Sie den Wiederherstellungsschlüssel bereit.

**Frage:** Welchen Vorteil bietet der Wiederherstellungsschlüssel?  
**Antwort:** Er ermöglicht das Migrieren oder Wiederherstellen Ihrer Gatewayeinstellungen. Er wird auch für die Notfallwiederherstellung verwendet.
...
**Frage:** Wie kann ich überprüfen, welche Abfragen an die lokale Datenquelle gesendet werden?  
