...
6. Sie können auch das Python-Skript ändern, um die Visualisierung anzupassen, und die Funktionsvielfalt von Python nutzen, indem Sie dem Zeichenbefehl Parameter hinzufügen.
    ...
    > **Python-Skript-Sicherheit:** Visuelle Python-Elemente werden aus Python-Skripts erstellt, die Code mit Sicherheits- oder Datenschutzrisiken enthalten können. Wenn ein Benutzer ein visuelles Python-Element zum ersten Mal aufruft oder damit interagiert, wird eine Sicherheitswarnmeldung angezeigt. Aktivieren Sie visuelle Python-Elemente nur dann, wenn Sie dem Autor und der Quelle vertrauen, oder wenn Sie die zugehörigen Python-Skripts überprüft und nachvollzogen haben.
    > 
    > 
