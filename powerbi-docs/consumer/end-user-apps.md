...
Planen Sie das Erstellen einer App? Weitere Informationen finden Sie unter [Create workspaces with your colleagues in Power BI (Gemeinsames Erstellen von Arbeitsbereichen mit Ihren Kollegen in Power BI)](end-user-create-apps.md).
...
* [Erstellen und Veröffentlichen von Apps in Power BI](end-user-create-apps.md)
