...
2. Suchen Sie das zu löschende Dashboard, und klicken Sie auf „Löschen“. ![Symbol „Löschen“](./media/end-user-delete/power-bi-delete-icon.png).
...
2. Suchen Sie den zu löschenden Bericht, und wählen Sie das Symbol „Löschen“ aus.   ![Symbol „Löschen“](./media/end-user-delete/power-bi-delete-icon.png).   

    ![Registerkarte „Berichte“ eines Arbeitsbereichs](./media/end-user-delete/power-bi-delete-reportnew.png)
3. Bestätigen Sie den Löschvorgang.

   ![Dialogfeld „Bericht löschen“](./media/end-user-delete/power-bi-delete-report.png)
...
2. Suchen Sie die zu löschende Arbeitsmappe, und wählen Sie das Symbol zum Löschen  ![Symbol „Löschen“](./media/end-user-delete/power-bi-delete-report2.png) aus.

    ![Registerkarte „Arbeitsmappe“](./media/end-user-delete/power-bi-delete-workbooknew.png)
3. Bestätigen Sie den Löschvorgang.

   ![Dialogfeld „Arbeitsmappe entfernen“](./media/end-user-delete/power-bi-delete-confirm.png)
...
2. Suchen Sie das zu löschende Dataset, und wählen Sie die Auslassungspunkte (...) aus.  
    ...
    ![Registerkarte „Datasets“](./media/end-user-delete/power-bi-delete-datasetnew.png)
3. Wählen Sie in der Dropdownliste **Löschen** aus.

   ![Das Menü mit Auslassungspunkten (...)](./media/end-user-delete/power-bi-delete-datasetnew2.png)
4. Bestätigen Sie den Löschvorgang.

   ![Dialogfeld „Dashboard löschen“](./media/end-user-delete/power-bi-delete-dataset-confirm.png)
...
1. Wählen Sie im linken Navigationsbereich **Arbeitsbereiche** aus.
    ...
    ![App-Arbeitsbereiche](./media/end-user-delete/power-bi-delete-workspace.png)
2. Wählen Sie die Auslassungspunkte (...) rechts neben dem zu löschenden Arbeitsbereich und dann **Arbeitsbereich bearbeiten** aus.

   ![Menü mit den Auslassungspunkten > Arbeitsbereich bearbeiten](./media/end-user-delete/power-bi-edit-workspace.png)
3. Wählen Sie im Fenster **Arbeitsbereich bearbeiten** die Option **Arbeitsbereich löschen** > **Löschen** aus.

    ![Arbeitsbereich löschen](./media/end-user-delete/power-bi-delete-workspace2.png)
...
2. Wählen Sie in der rechten oberen Ecke die Auslassungspunkte (...) und dann **Leave workspace** (Arbeitsbereich verlassen) > **Verlassen** aus.
      ...
      ![Arbeitsbereich verlassen](./media/end-user-delete/power-bi-leave-workspace.png)
...
2. Zeigen Sie auf die zu löschende App, und wählen Sie das Symbol „Löschen“ ![](./media/end-user-delete/power-bi-delete-report2.png) aus.

   ![Apps auswählen](./media/end-user-delete/power-bi-delete-app.png)

   Wenn Sie eine App versehentlich entfernen, stehen Ihnen mehrere Optionen zur Verfügung, um sie wieder zu erhalten.  Sie können den Ersteller der App bitten, sie erneut zu senden, Sie können die ursprüngliche E-Mail mit dem Link zur App suchen, Sie können in der [Mitteilungszentrale](end-user-notification-center.md) überprüfen, ob die Benachrichtigung für die App noch aufgeführt ist, oder Sie können [AppSource](end-user-apps.md) für Ihre Organisation überprüfen.
...
* [Entfernen eines ausgewählten Dashboards](end-user-featured.md#change-the-featured-dashboard)
* [Entfernen eines Dashboards aus den Favoriten](end-user-favorite.md)
* [Löschen einer Berichtsseite](end-user-delete.md)
* [Löschen einer Dashboardkachel](../service-dashboard-edit-tile.md)
* [Löschen einer Berichtsvisualisierung](end-user-delete.md)
