...
2. Öffnen Sie die Kachel im [Vollbildmodus](service-tile-fullscreen-mode.md), indem Sie in der oberen Navigationsleiste das Vollbildsymbol ![](media/service-print/power-bi-full-screen-icon.png) auswählen.
