...
Wenn Sie Dashboards und Berichte für Ihre Kunden einbetten, müssen sich die Dashboards und Berichte in einem App-Arbeitsbereich befinden. Informationen zum Erstellen eines App-Arbeitsbereichs finden Sie unter [Erstellen eines App-Arbeitsbereichs](../service-create-distribute-apps.md#create-an-app-workspace).

Das oben genannte *Hauptkonto* muss ein Administrator des App-Arbeitsbereichs sein.
